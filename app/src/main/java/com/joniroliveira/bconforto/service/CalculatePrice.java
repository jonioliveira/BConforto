...
public class CalculatePrice {
    ...
    public static Price calculate(double hours, float hoursPrice, double clothPrice, double quantity, int discount){
        double price = (hours * hoursPrice) + (clothPrice * quantity);
